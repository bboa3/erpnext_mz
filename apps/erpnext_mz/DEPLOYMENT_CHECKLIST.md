...
- [ ] Print formats configured via UI (optional)
...
# Not applicable for this app: print formats are managed in UI
```
...
- [ ] Verify print format access (if configured)
...
- [ ] Print formats work correctly (if configured)
